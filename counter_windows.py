...
class StartButton(arcade.TextButton):
    def __init__(self, center_x, center_y, text_size, action_function):
        super().__init__(center_x, center_y, 400, 100, "START", font_size=text_size, shadow_color=arcade.color.RED, font_color=arcade.color.BLACK, button_height=0, face_color=arcade.color.RED)
